...
{
    public partial class RectangleAttribute : UserControl
    {
        public MainForm SubParent = null;

        public RectangleAttribute(Color color)
        {
            InitializeComponent();
        ...
        {
            this.SubParent.CurrentPen.Width = (int)this.numericUpDown1.Value;
        }

        void panel1_BackColorChanged(object sender, EventArgs e)
        {
            this.SubParent.CurrentPen.Color = this.panel1.BackColor;
        }
        ...
        private void RectangleAttribute_Load(object sender, EventArgs e)
        {
            this.numericUpDown1.Value = (int)this.SubParent.CurrentPen.Width;
        }        
    }
}
