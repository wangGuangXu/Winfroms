...
{
    public partial class RectangleSelectAttribute : UserControl
    {
        public MainForm SubParent = null;
        public Brush PaperBrush = null;

        public RectangleSelectAttribute(Color color)
        {
            InitializeComponent();
        ...
        private void RectangleSelectAttribute_Load(object sender, EventArgs e)
        {
